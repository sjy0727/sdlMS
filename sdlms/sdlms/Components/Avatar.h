...
public:
    ...
    inline static const std::unordered_map<std::u16string, uint8_t> type_map = {
        {u"alert", ACTION::ALERT},     {u"dead", ACTION::DEAD},
        {u"fly", ACTION::FLY},         {u"heal", ACTION::HEAL},
        {u"jump", ACTION::JUMP},       {u"ladder", ACTION::LADDER},
        {u"prone", ACTION::PRONE},     {u"proneStab", ACTION::PRONESTAB},
        {u"rope", ACTION::ROPE},       {u"shot", ACTION::SHOT},
        {u"shoot1", ACTION::SHOOT1},   {u"shoot2", ACTION::SHOOT2},
        {u"shootF", ACTION::SHOOTF},   {u"sit", ACTION::SIT},
        {u"stabO1", ACTION::STABO1},   {u"stabO2", ACTION::STABO2},
        {u"stabOF", ACTION::STABOF},   {u"stabT1", ACTION::STABT1},
        {u"stabT2", ACTION::STABT2},   {u"stabTF", ACTION::STABTF},
        {u"stand1", ACTION::STAND1},   {u"stand2", ACTION::STAND2},
        {u"swingO1", ACTION::SWINGO1}, {u"swingO2", ACTION::SWINGO2},
        {u"swingO3", ACTION::SWINGO3}, {u"swingOF", ACTION::SWINGOF},
        {u"swingP1", ACTION::SWINGP1}, {u"swingP2", ACTION::SWINGP2},
        {u"swingPF", ACTION::SWINGPF}, {u"swingT1", ACTION::SWINGT1},
        {u"swingT2", ACTION::SWINGT2}, {u"swingT3", ACTION::SWINGT3},
        {u"swingTF", ACTION::SWINGTF}, {u"walk1", ACTION::WALK1},
        {u"walk2", ACTION::WALK2}};

    inline static const std::unordered_map<uint8_t, std::u16string> type_map2 = {
        {ACTION::ALERT, u"alert"},     {ACTION::DEAD, u"dead"},
        {ACTION::FLY, u"fly"},         {ACTION::HEAL, u"heal"},
        {ACTION::JUMP, u"jump"},       {ACTION::LADDER, u"ladder"},
        {ACTION::PRONE, u"prone"},     {ACTION::PRONESTAB, u"proneStab"},
        {ACTION::ROPE, u"rope"},       {ACTION::SHOT, u"shot"},
        {ACTION::SHOOT1, u"shoot1"},   {ACTION::SHOOT2, u"shoot2"},
        {ACTION::SHOOTF, u"shootF"},   {ACTION::SIT, u"sit"},
        {ACTION::STABO1, u"stabO1"},   {ACTION::STABO2, u"stabO2"},
        {ACTION::STABOF, u"stabOF"},   {ACTION::STABT1, u"stabT1"},
        {ACTION::STABT2, u"stabT2"},   {ACTION::STABTF, u"stabTF"},
        {ACTION::STAND1, u"stand1"},   {ACTION::STAND2, u"stand2"},
        {ACTION::SWINGO1, u"swingO1"}, {ACTION::SWINGO2, u"swingO2"},
        {ACTION::SWINGO3, u"swingO3"}, {ACTION::SWINGOF, u"swingOF"},
        {ACTION::SWINGP1, u"swingP1"}, {ACTION::SWINGP2, u"swingP2"},
        {ACTION::SWINGPF, u"swingPF"}, {ACTION::SWINGT1, u"swingT1"},
        {ACTION::SWINGT2, u"swingT2"}, {ACTION::SWINGT3, u"swingT3"},
        {ACTION::SWINGTF, u"swingTF"}, {ACTION::WALK1, u"walk1"},
        {ACTION::WALK2, u"walk2"}};

    inline static const std::unordered_map<std::u16string, Layer> layer_map = {
        {u"body", Layer::BODY},
...
public:
    inline static std::unordered_map<uint8_t, SDL_FPoint> body_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, SDL_FPoint> arm_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, SDL_FPoint> hand_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, SDL_FPoint> head_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, SDL_FPoint> hair_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, SDL_FPoint> face_positions[ACTION::LENGTH];
    inline static std::unordered_map<uint8_t, int32_t>    stance_delays[ACTION::LENGTH];

    // std::unordered_map<std::string, std::unordered_map<uint8_t, BodyAction>> body_actions;
    inline static std::unordered_map<uint8_t, bool>                     show_face[ACTION::LENGTH];
    inline static std::unordered_map<std::string, std::vector<int32_t>> attack_delays;
    inline static wz::Node*                                             character_node;
...
public:
    ...
    std::unordered_map<std::u16string, std::unordered_map<uint8_t, std::pair<Transform*, Sprite*>> (*)[ACTION::LENGTH]>
                                       zmap;
