...
Video::Video(AVFormatContext* formatContext,
             AVCodecContext*  codecContext,
             int              videoStreamIndex,
             SwsContext*      swsContext,
             int              width,
             int              height) :
    width(width), height(height), formatContext(formatContext), codecContext(codecContext),
    videoStreamIndex(videoStreamIndex), swsContext(swsContext)

{
    texture = SDL_CreateTexture(Window::get_renderer(),
